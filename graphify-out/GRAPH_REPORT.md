...
6. `MatchedAttendanceRecord` - 18 edges
...
Cohesion: 0.06
Nodes (55): ActionResult, approveRevisionAction(), approveSkippedAdjustmentAction(), beginPayrollCorrectionAction(), err(), getRevisionEmployeesAction(), getRevisionHistoryAction(), handleError() (+47 more)
...
Cohesion: 0.13
Nodes (19): EmployeeOption, EmployeeComboboxProps, EmployeeVerificationDialog(), EmployeeVerificationDialogProps, UnmatchedDecision, cn(), EMPLOYEE_OPTIONS, makeUnmatched() (+11 more)
...
Cohesion: 0.16
Nodes (16): ERROR_LABELS, FixInvalidRowDialog(), FixInvalidRowDialogProps, needsActive(), needsDesignation(), needsEmployeeId(), needsEmployeeName(), needsHourlyRate() (+8 more)
...
Cohesion: 0.19
Nodes (11): EmployeeForm(), EditEmployeePage(), EditEmployeePageProps, EmployeeProfilePage(), EmployeeProfilePageProps, getEmployeeById(), getEmployeeWageHistory(), generateMetadata() (+3 more)
...
Cohesion: 0.15
Nodes (6): ImportPreviewClient(), StoredPreviewData, TabKey, metadata, ExecuteImportResult, ParseImportResult
...
Cohesion: 0.20
Nodes (11): ActionResult, executeImportAction(), parseImportFileAction(), DragState, ImportDialog(), ImportDialogProps, UploadState, executeImport() (+3 more)
...
Cohesion: 0.26
Nodes (7): mapActiveValue(), parseExcelDate(), parseNumber(), RawRow, validateAndParseRow(), DuplicateImportRow, normalizeEmployeeId()

### Community 74 - "Community 74"
Cohesion: 0.22
Nodes (10): excelTimeToHours(), formatExcelTime(), parseAttendanceWorkbook(), parseSection(), parseSheet(), SECTION_BASES, SECTION_BASES, SectionSpec (+2 more)
...
Cohesion: 0.26
Nodes (6): GET(), generateExportWorkbook(), IMPORT_COLUMNS, ImportFileErrorCode, ImportRowAction, ImportRowSchema
