...
- Name: payroll-reports\reports-flow.spec.ts >> E2E-01: PDF payroll summary API >> GET /api/payroll/reports/:id/summary returns a valid PDF
- Location: e2e\payroll-reports\reports-flow.spec.ts:25:7
