...
- Name: payroll-adjustments\adjustments-flow.spec.ts >> E2E-02: Create recurring addition with fixed weeks >> creates a recurring addition for 4 weeks
- Location: e2e\payroll-adjustments\adjustments-flow.spec.ts:62:7
...
Locator: locator('td:has-text("Recurring")')
Expected: visible
Error: strict mode violation: locator('td:has-text("Recurring")') resolved to 3 elements:
    1) <td class="px-4 py-3">…</td> aka getByRole('cell', { name: 'Recurring' }).first()
    2) <td class="px-4 py-3">…</td> aka getByRole('cell', { name: 'Recurring' }).nth(1)
    3) <td class="px-4 py-3">…</td> aka getByRole('cell', { name: 'Recurring' }).nth(2)

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('td:has-text("Recurring")')
    ...
    - main [ref=e49]:
      - generic [ref=e50]:
        ...
        - table [ref=e62]:
          ...
          - rowgroup [ref=e70]:
            - row "Adjustment Test Employee EMP-ADJ-001 Addition ₹1,000 Recurring Active" [ref=e71] [cursor=pointer]:
              - cell "Adjustment Test Employee EMP-ADJ-001" [ref=e72]:
                - generic [ref=e73]:
                  - generic [ref=e74]: Adjustment Test Employee
                  - generic [ref=e75]: EMP-ADJ-001
              - cell "Addition" [ref=e76]:
                - generic [ref=e77]: Addition
              - cell "₹1,000" [ref=e78]:
                - generic [ref=e79]: ₹1,000
              - cell "Recurring" [ref=e80]
              - cell "Active" [ref=e81]:
                - generic [ref=e82]:
                  - img [ref=e83]
                  - text: Active
